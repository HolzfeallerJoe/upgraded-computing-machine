...
def value_of_ace(card_one, card_two):
    ...
    card_one_value = value_of_card(card_one) if value_of_card(card_one) != 1 else 11
    card_two_value = value_of_card(card_two) if value_of_card(card_two) != 1 else 11
...
def can_double_down(card_one, card_two):
    ...
    print(card_two_value + card_one_value)
